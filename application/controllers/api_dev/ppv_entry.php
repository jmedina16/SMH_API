...
class Ppv_entry extends REST_Controller {

    public function __construct() {

        parent::__construct();
        $this->load->model('/ppv_dev/ppv_entry_model');
    }
    ...
    public function list_entry_get() {
        ...
        $entryList = $this->ppv_entry_model->get_entry_list($pid, $ks, $start, $length, $search, $draw);
    ...
    public function list_entry_names_get() {
        ...
        $entryNames = $this->ppv_entry_model->list_entry_names($pid);
    ...
    public function add_entry_get() {
        ...
        $ticket_ids = $this->get('ticket_ids');
//        $ppv_player_id = $this->get('ppv_player_id');
//        $ppv_player_button_id = $this->get('ppv_player_button_id');
        ...
        if (!isset($ticket_ids) || $ticket_ids == null) {

            $this->response(array('error' => 'Missing ticket id'), 200);
        }

//        if (!isset($ppv_player_id) || $ppv_player_id == null) {
//
//            $this->response(array('error' => 'Missing ppv player id'), 200);
//        }
//
//        if (!isset($ppv_player_button_id) || $ppv_player_button_id == null) {
//
//            $this->response(array('error' => 'Missing ppv player button id'), 200);
//        }
        ...
        $addEntry = $this->ppv_entry_model->add_entry($pid, $ks, $kentry_id, $kentry_name, $ac_id, $ac_name, $media_type, $ticket_ids, $status);
...
//        }
        ...
        $updateEntry = $this->ppv_entry_model->update_entry($pid, $ks, $kentry_id, $kentry_name, $ac_id, $ac_name, $media_type, $ticket_ids);
    ...
    public function delete_entry_get() {
        ...
        $deleteEntry = $this->ppv_entry_model->delete_entry($pid, $ks, $kentry_id, $media_type);
    ...
    public function delete_platform_entry_get() {
        ...
        $deleteEntry = $this->ppv_entry_model->delete_platform_entry($pid, $ks, $kentry_id);
    ...
    public function update_entry_status_get() {
        ...
        $updateEntryStatus = $this->ppv_entry_model->update_status($pid, $ks, $kentry_id, $status);
    ...
    public function get_entry_details_get() {
        ...
        $entry = $this->ppv_entry_model->get_entry_details($sm_ak, $kentry_id);
    ...
    public function get_cat_details_get() {
        ...
        $entry = $this->ppv_entry_model->get_cat_details($sm_ak, $kentry_id);
    ...
    public function update_playlist_entry_get() {
        $pid = $this->get('pid');
        $ks = $this->get('ks');
        $ac_id = $this->get('ac_id');
        ...
        if (!isset($ac_id) || $ac_id == null) {
            ...
            $this->response(array('error' => 'Missing ac_id'), 200);
        }
        ...
        $result = $this->ppv_entry_model->update_playlist_entry($pid, $ks, $ac_id, $playlist_id);
    ...
    public function check_update_ac_get() {
        ...
        $result = $this->ppv_entry_model->check_update_ac($pid, $ks, $playlist_id, $playlist);
    ...
    public function delete_playlist_entry_get() {
        ...
        $result = $this->ppv_entry_model->delete_playlist_entry($pid, $ks, $playlist_id);
    ...
    public function get_cat_entries_get() {
        ...
        $entries = $this->ppv_entry_model->get_cat_entries($sm_ak, $cat_id);
    ...
    public function update_platform_cat_get() {
        ...
        $result = $this->ppv_entry_model->update_platform_cat($pid, $ks, $cat, $entry_id);
    ...
    public function update_drag_cat_get() {
        ...
        $result = $this->ppv_entry_model->update_drag_cat($pid, $ks, $cat_id, $entry_id);
    ...
    public function delete_platform_cat_get() {
        ...
        $result = $this->ppv_entry_model->delete_platform_cat($pid, $ks, $cat_id);
