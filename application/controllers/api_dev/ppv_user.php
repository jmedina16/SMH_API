...
class Ppv_user extends REST_Controller {

    public function __construct() {

        parent::__construct();
        $this->load->model('/ppv_dev/ppv_user_model');
    ...
    public function list_user_get() {
        ...
        $userList = $this->ppv_user_model->get_user_list($pid, $ks, $start, $length, $search, $draw);
    ...
    public function update_user_get() {
        ...
        $updateUser = $this->ppv_user_model->update_user($pid, $ks, $uid, $fname, $lname, $email, $tz);
    ...
    public function update_user_pswd_get() {
        ...
        $updateUserPswd = $this->ppv_user_model->update_pswd($pid, $ks, $email, $pass, $tz);
    ...
    public function update_user_status_get() {
        ...
        $updateUserStatus = $this->ppv_user_model->update_status($pid, $ks, $email, $status, $uid, $tz);
    ...
    public function update_user_restriction_get() {
        $pid = $this->get('pid');
        $ks = $this->get('ks');
        $email = $this->get('email');
        ...
        if (!isset($restriction) || $restriction == null) {

            $this->response(array('error' => 'Missing restriction'), 200);
        }

        $updateUserRestriction = $this->ppv_user_model->update_restriction($pid, $ks, $email, $restriction, $tz);

        if (!$updateUserRestriction) {

            $this->response($updateUserRestriction, 200);
        }

        $this->response($updateUserRestriction, 200); // 200 being the HTTP response code
    }
    ...
    public function login_user_get() {
        ...
        $loginUser = $this->ppv_user_model->login_user($un, $pswd, $sm_ak, $entryId);
    ...
    public function add_user_get() {
        ...
        $addUser = $this->ppv_user_model->add_user($pid, $ks, $fname, $lname, $email, $pass, $restriction, $status, $tz);
    ...
    public function register_user_get() {
        ...
        $addUser = $this->ppv_user_model->register_user($sm_ak, $fname, $lname, $email, $pass, $tz, $url, $attrs);
    ...
    public function activate_user_get() {
        ...
        $activateUser = $this->ppv_user_model->activate_user($sm_ak, $akey, $email, $tz);
    ...
    public function delete_user_get() {
        ...
        $deleteUser = $this->ppv_user_model->delete_user($pid, $ks, $uid);
    ...
    public function destroy_session_get() {
        ...
        $destroySession = $this->ppv_user_model->destroy_session($pid, $ks, $uid);
    ...
    public function list_user_names_get() {
        ...
        $userNames = $this->ppv_user_model->list_user_names($pid);
    ...
    public function get_user_details_get() {
        ...
        $userName = $this->ppv_user_model->get_user_details($sm_ak, $uid);
    ...
    public function update_fname_get() {
        ...
        $userName = $this->ppv_user_model->update_fname($sm_ak, $auth_key, $fname);
    ...
    public function update_lname_get() {
        ...
        $userName = $this->ppv_user_model->update_lname($sm_ak, $auth_key, $lname);
    ...
    public function get_user_name_get() {
        ...
        $userName = $this->ppv_user_model->get_user_name($sm_ak, $uid);
    ...
    public function is_logged_in_get() {
        ...
        $user = $this->ppv_user_model->is_logged_in($auth_key, $sm_ak);
    ...
    public function create_auth_key_get() {
        ...
        $authKey = $this->ppv_user_model->create_auth_key($un, $uid, $sm_ak);
    ...
    public function reset_psswd_request_get() {
        ...
        $reset = $this->ppv_user_model->reset_psswd_request($email, $sm_ak, $url);
    ...
    public function reset_email_request_get() {
        ...
        $reset = $this->ppv_user_model->reset_email_request($email, $sm_ak, $url);
    ...
    public function reset_pass_get() {
        ...
        $reset = $this->ppv_user_model->reset_pass($email, $sm_ak, $reset_token, $pass);
    ...
    public function reset_email_get() {
        ...
        $reset = $this->ppv_user_model->reset_email($email, $new_email, $sm_ak, $reset_token, $pass);
    ...
    public function is_active_get() {
        ...
        $is_active = $this->ppv_user_model->is_active($sm_ak, $uid);
    ...
    public function is_not_active_get() {
        ...
        $is_active = $this->ppv_user_model->is_not_active($sm_ak, $uid);
    ...
    public function user_concurrent_status_get() {
        ...
        $result = $this->ppv_user_model->user_concurrent_status($pid, $ks, $concurrent);
    ...
    public function get_concurrent_status_get() {
        ...
        $result = $this->ppv_user_model->get_concurrent_status($pid);
    ...
    public function user_activation_skip_status_get() {
        ...
        $result = $this->ppv_user_model->user_activation_skip_status($pid, $ks, $skip);
    ...
    public function get_activation_skip_status_get() {
        ...
        $result = $this->ppv_user_model->get_activation_skip_status($pid);
    ...
    public function get_owner_attrs_get() {
        ...
        $result = $this->ppv_user_model->get_owner_attrs($pid, $ks);
    ...
    public function update_reg_fields_get() {
        ...
        $result = $this->ppv_user_model->update_reg_fields($pid, $ks, $newFields, $updateFields, $removeFields);
    ...
    public function update_user_details_get() {
        ...
        $result = $this->ppv_user_model->update_user_details($pid, $uid, $ks, $updateFields);
