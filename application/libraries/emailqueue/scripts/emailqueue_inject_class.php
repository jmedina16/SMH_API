<?
	...
	class emailqueue_inject_class
	{
        ...
        function emailqueue_inject_construct($params)
        {            
            $this->db_host = $params['db_host'];
            $this->db_user = $params['db_user'];
            $this->db_password = $params['db_password'];
            $this->db_name = $params['db_name'];
            $this->avoidpersistence = $params['avoidpersistence'];
            $emailqueue_timezone = $params['emailqueue_timezone'];
